  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs flex justify-between items-center">
        <div>
          <h2 className="text-xl font-bold text-slate-900">Seed Fundraising Round</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
          ...
          <div>
            <label className="block text-xs text-slate-500 mb-1">Target Raise Amount ($)</label>
            <input
              type="number"
              value={targetAmount}
          ...
          <div>
            <label className="block text-xs text-slate-500 mb-1">Discount Rate (%)</label>
            <input
              type="number"
              value={discountRate}
        ...
        <div className="md:col-span-2 bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-4">
          <h3 className="text-sm font-bold text-slate-900">Active Angel & VC Pipeline</h3>
            ...
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-slate-100">
                <tr className="hover:bg-slate-50 transition">
                  <td className="py-3 px-4 font-semibold text-slate-900">{maskName('Apex Ventures', privacyMode)}</td>
                  ...
                  <td className="py-3 px-4 text-right font-bold text-slate-900">{maskMoney(100000, privacyMode)}</td>
                </tr>
                <tr className="hover:bg-slate-50 transition">
                  <td className="py-3 px-4 font-semibold text-slate-900">{maskName('Summit Capital', privacyMode)}</td>
                  ...
                  <td className="py-3 px-4 text-right font-bold text-slate-900">{maskMoney(150000, privacyMode)}</td>
                </tr>
              </tbody>
            </table>
          </div>
