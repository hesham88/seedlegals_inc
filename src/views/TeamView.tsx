  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto pb-12">
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs flex justify-between items-center">
        <div>
          <h2 className="text-xl font-bold text-hd">Board, Officers & Team</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {stockholders.map((person) => (
          <div key={person.id} className="p-5 glass-card">
            <div className="flex items-start gap-3.5">
              ...
              <div className="min-w-0 flex-1">
                <h3 className="font-bold text-sm text-hd">{maskName(person.name, privacyMode)}</h3>
                <div className="text-xs text-mut flex items-center gap-1.5 mt-0.5">
                  <Mail className="w-3.5 h-3.5 text-mut" />
                ...
                <div className="mt-3 p-3 bg-slate-50 rounded-xl text-xs text-body space-y-1 border border-slate-100">
                  <div className="flex justify-between">
                    <span>Shares Held:</span>
                    <span className="font-bold text-hd">{person.shareCount.toLocaleString()} Common</span>
                  </div>
                  <div className="flex justify-between">
